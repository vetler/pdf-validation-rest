...
public class Validator {
    ...
    private static String testAssertionToString(TestAssertion t) {
    ...
    public static class Result {
        ...
        public static class ResultBuilder {
            ...
            public PDFAFlavour flavour = null;
            public List<String> errors = emptyList();

            public ResultBuilder with(
                    Consumer<ResultBuilder> builderFunction) {
